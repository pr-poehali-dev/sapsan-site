    ...
    <div className="max-w-4xl mx-auto px-8 relative z-10">
      ...
      <div className="flex flex-col md:flex-row gap-12 items-start">
        ...
        <div className="md:w-2/3 space-y-6">
          ...
          <p className="font-serif text-lg leading-relaxed text-[var(--ink-color)]">
            Книга-история и книга-урок. Повествователь рассказывает с самого начала,
...
const excerpts = [
  {
    chapter: "Глава 1",
    title: "Откуда и зачем",
    text: "На современной троянской войне под названием «Автобизнес» я провел 30 лет, от самых бандитских времен и до настоящего времени, которое тоже язык не повернется назвать спокойной гаванью.",
  },
  {
    chapter: "Глава 4",
    title: "Был бы человек, статью найдём",
    text: "То обстоятельство, что человек не нарушает закон, для МВД Татарстана никогда не имело значения, здесь действует старое правило: «Был бы человек, а статья найдется» (как говаривал сталинский прокурор Андрей Вышинский). А вот второе, это святое — если ты из одной деревни с влиятельным человеком, то в Татарстане становишься неприкасаемым.",
  },
  {
    chapter: "Глава 23",
    title: "Подпольный предприниматель",
    text: "Предпринимательский опыт я видел с самого детства. Моя мать работала на швейной фабрике в СССР закройщиком. А эта должность позволяла ей общаться с главами наркома и руководителей организаций. Опыт договориться, разрешить тяжёлую ситуацию, сшить кому-то вне очереди открывал ей дорогу к новым большим заказам.",
  },
];
...
const booksData = [
  ...
  },
  {
    ...
    description: "Свободные размышления повествователя о жизни, людях, стране и времени. Без хронологии и без цензуры — честный взгляд человека, прошедшего путь от рабочего до миллиардера.",
    parts: [
      {
        label: "",
        period: "",
        chapters: ["Рассуждения «повествователя» на разные темы"],
      },
    ],
  },
];
